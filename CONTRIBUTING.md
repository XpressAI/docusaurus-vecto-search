...
Note: if you are editing `docusaurus/src/client/theme/**/*.css` or `docusaurus/src/locales/*.json`, you should run `yarn workspace @xpressai/docusaurus-vecto-search run copy-static-files` each time you edited these files.
