      ...
      <a href="https://vecto.ai/" target="_blank" rel="noopener noreferrer">
        ...
        >
          <g>
            <polygon
              fill="#00D7F2"
              points="42,37.3 51.3,32.7 43.2,17 42,16.7 0,3.1 20.3,38.5 12.6,51.9"
            />
            <polygon
              fill="#00D7F2"
              points="61,9.4 100.9,16.7 68.9,65.4 57.6,45.2 42,53.4 32.8,58.2 42,73.9 68.7,119.1 143.6,0.4"
            />
          </g>
          <path
            fill="#000109"
            d="M280.2,72.6c0.2-1.4,0.3-2.8,0.3-4.2c0-8.6-3.1-16-9.2-22.1c-6.1-6.1-13.5-9.2-22.1-9.2l0,0
          ...
          <path
            fill="#000109"
            d="M318.5,99.6c-8.6,0-16-3.1-22.1-9.2c-6.1-6.1-9.2-13.5-9.2-22.1c0-8.6,3.1-16,9.2-22.1
          ...
          <path
            fill="#000109"
            d="M374.3,19.9v16.6h6.3v10.4h-6.3v31.9c0,2,0.7,3.6,2,4.9c1.3,1.3,3,2,4.8,2h3.5v13.9h-3.5
            c-5.7,0-10.6-2-14.7-6.1c-4-4.1-6.1-9-6.1-14.7V46.9h-6.3V36.5h6.3v-9.7L374.3,19.9z"
          />
          <path
            fill="#000109"
            d="M442.4,46.4c-6.1-6.1-13.5-9.2-22.1-9.2c-8.6,0-16,3.1-22.1,9.2c-6.1,6.1-9.2,13.5-9.2,22.1
          ...
          <polygon
            fill="#000109"
            points="154.9,37.2 170.7,37.2 186.3,73.7 201.9,37.2 217.6,37.2 191.3,99.1 181.2,99.1"
          />
        </svg>
      </a>
    </div>
